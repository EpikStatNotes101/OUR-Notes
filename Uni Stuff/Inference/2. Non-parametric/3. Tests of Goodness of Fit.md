...
In order to apply the chi-square test in this situation, the sample data is first grouped using some scheme to form a frequency distribution. When the sample is quantative in nature, the hypothesized distribution would be discrete and the categories would be relevant verbal or numerical classification. When the sample observations are quantative, the categories would be n
