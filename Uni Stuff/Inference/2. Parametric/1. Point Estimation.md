...
A constant which changes its value from one situation to another is a known parameter. The set of all admissible values of a parameter is often called	the parameter space $\Theta$. 
